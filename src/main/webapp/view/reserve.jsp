...
@font-face {
	...
	* { font-family: 'Jeju Myeongjo', serif; }
	...
	span { color: red; }
	.res_notice, #res_subject, #content, #res_content, span { font-family: 'GongGothicMedium'; }
	#res_hr {
		width: 1200px;
		height: 1px;
		border: 0px;
...
<%@ include file="header.jsp" %>
	...
	<div class="res_notice">
		...
		<div id="content">
			<p id="res_content">
				1. 예약은 <span>웹 예약</span> 또는 <span>카카오톡 오픈채팅</span>으로 문의 부탁드립니다.<br><br>
				...
				3. 시술 중에는 답변이 느릴 수도 있으며, <span>순차적으로</span> 예약시간에 맞춰드리고 있습니다.<br><br>
